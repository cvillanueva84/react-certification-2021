export const getVids = async (categoria) => {
  ...
  //const API_KEY = 'AIzaSyDowbC2QxBtmWzCjTFGeVoTzpjXkCv8WXY';
  const urlYoutube = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=25&order=relevance&key=AIzaSyDowbC2QxBtmWzCjTFGeVoTzpjXkCv8WXY&q=${encodeURI(categoria)}`;
