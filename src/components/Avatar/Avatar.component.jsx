...
const Avatar = () => {
  ...
  const { hideAvatarDropdown, showAvatarDropdown, darkMode } = stateContext;

  return (
    <Container onMouseDown={showAvatarDropdown} onMouseLeave={hideAvatarDropdown}>
      <img
      ...
      />
      <div>
        {!stateContext.avatar.showDropdown ? (
          <div />
        ) : (
